...
import { setMsgsToday, toggleOpen } from "@/store/assistantSlice";
...
export function AssistantPanel() {
  ...
  const editorSnapshot = editorContent
    ? editorContent.replace(/<[^>]*>/g, "").slice(0, 500)
    : undefined;
        ...
        <div style={{ padding: 12, borderTop: "1px solid var(--line)" }}>
          <div className="row" style={{ gap: 6, alignItems: "center" }}>
            ...
            <button
              ...
              style={{
                padding: 8,
                color: voiceStatus === "listening" ? "var(--accent)" : "var(--ink-mute)",
              }}
              onClick={handleVoice}
