...
const SYSTEM_TEMPLATES = [
  {
    ...
    category: "social",
    promptSchema:
      "Génère un post LinkedIn viral sur {{sujet}} pour {{audience}}. Utilise un ton {{ton}} avec une accroche qui interpelle dès la première ligne, un développement en 3 points clés, et un CTA engageant.",
    variables: [
  ...
  },
  {
    ...
    category: "marketing",
    promptSchema:
      "Rédige un article de blog SEO complet sur {{sujet}} ciblant le mot-clé principal {{motcle}}. Structure : titre H1 accrocheur + introduction avec le problème + 4 sections H2 avec sous-titres H3 + conclusion avec CTA. Longueur : 1000-1500 mots.",
    variables: [
  ...
  },
  {
    ...
    category: "business",
    promptSchema:
      "Écris un email de prospection B2B pour proposer {{service}} à {{entreprise}}. Objet percutant + introduction personnalisée + identification du problème + solution + preuve sociale + CTA simple pour un appel de 15 min. Ton professionnel et direct, maximum 150 mots.",
    variables: [
  ...
  },
  {
    ...
    category: "marketing",
    promptSchema:
      "Rédige une description produit persuasive pour {{produit}} vendu à {{prix}}. Bénéfices clés en bullet points + storytelling émotionnel + caractéristiques techniques + garanties + CTA. Optimisé pour la conversion.",
    variables: [
  ...
  },
  {
    ...
    category: "social",
    promptSchema:
      "Écris un script YouTube de 5-10 minutes sur {{sujet}}. Structure : hook choc (0-30s) + teaser du contenu + introduction + 3 parties principales avec transitions + conclusion + CTA abonnement. Ton {{ton}}, adapté à {{audience}}.",
    variables: [
  ...
  },
  {
    ...
    category: "business",
    promptSchema:
      "Génère un pitch investisseur pour {{startup}} dans le secteur {{secteur}}. Structure : problème marché + solution innovante + taille de marché + modèle économique + traction actuelle + équipe + appel à financement de {{montant}}.",
    variables: [
  ...
  },
  {
    ...
    category: "social",
    promptSchema:
      "Crée un thread Twitter de 10 tweets éducatifs sur {{sujet}}. Tweet 1 : accroche avec promesse. Tweets 2-9 : une idée par tweet, format court et percutant. Tweet 10 : résumé + CTA follow. Utilise des chiffres et des analogies concrètes.",
    variables: [{ key: "sujet", label: "Sujet du thread", required: true }],
    isPublic: true,
    isPro: false,
  },
  {
    ...
    category: "marketing",
    promptSchema:
      "Rédige une newsletter hebdomadaire sur {{theme}} pour {{audience}}. Structure : accroche personnelle + 3 ressources/actualités commentées + 1 tip actionnable + recommandation de la semaine + mot de fin chaleureux. Ton {{ton}}.",
    variables: [
