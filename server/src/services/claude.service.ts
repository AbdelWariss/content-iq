...
import type { GenerateContentInput, ContentType, ContentLanguage } from "@contentiq/shared";
...
const CONTENT_TYPE_LABELS: Record<ContentType, Record<ContentLanguage, string>> = {
  ...
  linkedin: { fr: "post LinkedIn", en: "LinkedIn post", es: "publicación de LinkedIn", ar: "منشور لينكد إن" },
  instagram: { fr: "légende Instagram", en: "Instagram caption", es: "descripción de Instagram", ar: "تعليق انستغرام" },
  twitter: { fr: "thread Twitter/X", en: "Twitter/X thread", es: "hilo de Twitter/X", ar: "خيط تويتر" },
  email: { fr: "email marketing", en: "marketing email", es: "correo de marketing", ar: "بريد تسويقي" },
  newsletter: { fr: "newsletter", en: "newsletter", es: "boletín", ar: "نشرة إخبارية" },
  product: { fr: "description produit", en: "product description", es: "descripción de producto", ar: "وصف المنتج" },
  pitch: { fr: "pitch / elevator pitch", en: "elevator pitch", es: "discurso de ascensor", ar: "عرض تقديمي" },
  youtube: { fr: "script vidéo YouTube", en: "YouTube video script", es: "guión de YouTube", ar: "سكريبت يوتيوب" },
  bio: { fr: "bio professionnelle", en: "professional bio", es: "biografía profesional", ar: "سيرة مهنية" },
  press: { fr: "communiqué de presse", en: "press release", es: "comunicado de prensa", ar: "بيان صحفي" },
...
const TONE_LABELS: Record<string, Record<ContentLanguage, string>> = {
  professional: { fr: "professionnel et sérieux", en: "professional and serious", es: "profesional y serio", ar: "مهني وجاد" },
  casual: { fr: "décontracté et naturel", en: "casual and natural", es: "informal y natural", ar: "غير رسمي وطبيعي" },
  inspiring: { fr: "inspirant et motivant", en: "inspiring and motivating", es: "inspirador y motivador", ar: "ملهم ومحفز" },
  technical: { fr: "technique et précis", en: "technical and precise", es: "técnico y preciso", ar: "تقني ودقيق" },
  humorous: { fr: "humoristique et léger", en: "humorous and light", es: "humorístico y ligero", ar: "فكاهي وخفيف" },
  persuasive: { fr: "persuasif et convaincant", en: "persuasive and convincing", es: "persuasivo y convincente", ar: "مقنع ومؤثر" },
};
...
function buildUserPrompt(params: GenerateContentInput): string {
  ...
  const lengthMap: Record<string, Record<ContentLanguage, string>> = {
    short: { fr: "court (moins de 300 mots)", en: "short (less than 300 words)", es: "corto (menos de 300 palabras)", ar: "قصير (أقل من 300 كلمة)" },
    medium: { fr: "moyen (300 à 800 mots)", en: "medium (300 to 800 words)", es: "medio (300 a 800 palabras)", ar: "متوسط (300 إلى 800 كلمة)" },
    long: { fr: "long (800 à 2000 mots)", en: "long (800 to 2000 words)", es: "largo (800 a 2000 palabras)", ar: "طويل (800 إلى 2000 كلمة)" },
    custom: { fr: `personnalisé (~${params.customLength ?? 500} mots)`, en: `custom (~${params.customLength ?? 500} words)`, es: `personalizado (~${params.customLength ?? 500} palabras)`, ar: `مخصص (~${params.customLength ?? 500} كلمة)` },
  };
  ...
  const typeInstructions: Partial<Record<ContentType, string>> = {
    linkedin: "Structure : accroche percutante + développement + CTA. Utilise des sauts de ligne fréquents.",
    ...
    pitch: "Structure : problème + solution + marché cible + proposition de valeur + appel à l'action.",
