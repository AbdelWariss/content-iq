  ...
  const scheduleScenes = useCallback((playedMs: number) => {
    ...
    if (!scene1DoneRef.current && rem1 > 0)
      t1Ref.current = setTimeout(() => {
        setScene(1);
        scene1DoneRef.current = true;
      }, rem1);
    if (!scene2DoneRef.current && rem2 > 0)
      t2Ref.current = setTimeout(() => {
        setScene(2);
        scene2DoneRef.current = true;
      }, rem2);
  }, []);
    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            className="t-mono"
            style={{ fontSize: 11, color: "var(--ink-mute)", flexShrink: 0 }}
          >
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            filter: "blur(80px)",
            animation: "floatB 24s ease-in-out 4s infinite",
          }}
        />
        ...
        <div
          style={{
            ...
            filter: "blur(80px)",
            animation: "floatA 22s ease-in-out 12s infinite",
          }}
        />
        ...
        <div
          style={{
            ...
            height: 480,
            borderRadius: "50%",
            background: "rgba(107,184,189,0.09)",
            filter: "blur(90px)",
            animation: "floatB 26s ease-in-out 6s infinite",
          }}
        />
        {/* Coral — CTA / footer */}
        <div
      ...
      <div
        ...
        style={{
          ...
          position: "sticky",
          top: 0,
          background: "rgba(248,247,245,0.70)",
        ...
        <div style={{ position: "relative", height: 540 }}>
          ...
          >
            ...
            <div style={{ padding: 22, background: "transparent" }}>
              ...
              >
                « Annonce du lancement de notre nouveau plan Business pour les agences de
                communication africaines. »
              </div>
              ...
              <div style={{ fontSize: 13.5, lineHeight: 1.65, color: "var(--ink)" }}>
                ...
                <br />
                <br />
                Pendant des années, les meilleurs outils ont été conçus ailleurs, pour d'autres.
                Aujourd'hui, on change ça.
                <br />
                <br />
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 4px 28px rgba(107,184,189,0.46), 0 8px 20px rgba(58,47,37,0.06), inset 0 1.5px 0 rgba(255,255,255,0.95)",
            }}
          >
            <div
              style={{
      ...
      <div
        ...
        style={{
          ...
          borderBottom: "1px solid var(--line)",
          background:
            "linear-gradient(165deg, rgba(107,184,189,0.28) 0%, rgba(107,184,189,0.08) 50%, var(--bg-sunk) 100%)",
        }}
      >
        <div
          style={{
        ...
        >
          ...
          <div id="usecases" className="col" style={{ gap: 10 }}>
            ...
            {[
              {
                cmd: '"Génère un post LinkedIn inspirant sur notre nouveau produit"',
                result: "Post LinkedIn · 280 mots · 2.1 cr.",
              },
              {
                cmd: '"Améliore le ton, rends-le plus percutant"',
                result: "Révision appliquée · 0.9 cr.",
              },
