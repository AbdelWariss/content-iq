    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1.1fr", height: "100%" }}>
      ...
      >
        ...
        <div style={{ maxWidth: 380, width: "100%" }}>
          ...
          <div className="row" style={{ gap: 10, margin: "18px 0" }}>
            ...
            <span className="t-eyebrow" style={{ fontSize: 11, color: "var(--ink-mute)" }}>
              OU
            </span>
            <div className="hr" style={{ flex: 1 }} />
          </div>
            ...
            <div className="col" style={{ gap: 12 }}>
              ...
              <div>
                <div className="row between">
                  ...
                  <Link to="/forgot-password" className="lnk" style={{ fontSize: 11.5 }}>
                    Oublié ?
                  </Link>
                </div>
      ...
      >
        ...
        <div className="row" style={{ gap: 12 }}>
          <div
            className="imgph"
            style={{ width: 44, height: 44, borderRadius: "50%", fontSize: 14 }}
          >
            AM
          </div>
          <div className="col">
            ...
            <span style={{ fontSize: 12, color: "var(--ink-mute)" }}>
              Directrice — Studio Baobab, Dakar
            </span>
          </div>
        </div>
